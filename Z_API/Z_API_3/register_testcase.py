...
if __name__ == '__main__':
    do_excel = Do_Excel("Testcase.xlsx", sheet_name="register")
    ...
    for case in case_read:
        ...
        do_excel = Do_Excel("Testcase.xlsx", sheet_name="recharge")
        resp_login = http_request.request(case.method, case.url, case.data)
